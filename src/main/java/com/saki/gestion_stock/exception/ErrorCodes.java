...
public enum ErrorCodes {
    ...
    BAD_CREDENTIALS(12004), // ← CORRECTION: code dupliqué

    VENTE_NOT_FOUND(13000),
    VENTE_NOT_VALID(13001),
    VENTE_ALREADY_IN_USE(13002),

    // AJOUTEZ CES CODES POUR LA GESTION DE STOCK :
    STOCK_INSUFFISANT(15000),
    QUANTITE_INVALIDE(15001),
    OPERATION_NOT_VALID(15002),
