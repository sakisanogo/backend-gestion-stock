...
public class ArticleController implements ArticleApi {
    ...
    @Override
    public List<LigneCommandeClientDto> findHistoriqueCommandeClient(Integer idArticle) { // ⬅️ CORRIGÉ
        return articleService.findHistoriaueCommandeClient(idArticle); // ⬅️ CORRIGÉ
    }
